 ...
 * the current nav item. Valid values: dashboard, quakebot, map, reports, recipients
 *
 * Usage:
...
$navItems = [
    ...
    'map'        => ['href' => 'admin_map.php',         'label' => 'Map',        'icon' => 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7'],
...
<div class="md:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-3 shadow-sm" style="background-color: var(--nav-bg); border-bottom: 1px solid var(--nav-border);">
    ...
    <div class="flex items-center space-x-2">
        ...
        <span class="font-bold text-sm theme-text-primary">ND-SCPM</span>
    </div>
    ...
    <div class="flex items-center px-4 py-5 flex-shrink-0 sidebar-header" style="border-bottom: 1px solid var(--nav-border);">
        <div class="flex items-center space-x-3 flex-1 min-w-0 sidebar-brand">
            ...
            <div class="sidebar-label min-w-0">
                <h1 class="text-base font-bold theme-text-primary whitespace-nowrap">ND-SCPM</h1>
                <p class="text-xs theme-text-tertiary whitespace-nowrap">Earthquake Monitor</p>
            </div>
        </div>
