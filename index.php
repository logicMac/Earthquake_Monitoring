        ...
        <div class="w-full mx-auto px-4 sm:px-6 py-3 sm:py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="hidden md:flex items-center space-x-2 sm:space-x-4">
                        ...
                        <a href="admin_map.php" class="theme-btn-secondary px-4 py-2 rounded-lg font-medium text-sm transition button-hover">
                            Map
                        </a>
            ...
            <div id="mobileMenu" class="md:hidden mt-3 pt-3" style="border-top: 2px solid var(--border-primary);">
                <div class="flex flex-col space-y-2">
                    ...
                    <a href="admin_map.php" class="theme-btn-secondary px-4 py-2 rounded-lg font-medium text-sm transition text-center">
                        Map
                    </a>
